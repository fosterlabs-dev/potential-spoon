...
const TEMPLATES: TemplateRow[] = [
  ...
  },
  {
    key: 'dates_unclear_ask_clarify',
    variant: 2,
    text: `Hi to make sure I check the right dates, could you let me know the exact Sunday you'd arrive and Sunday you'd leave?\n\nMany thanks\nwww.bontemaison.com`,
  },
  {
    key: 'dates_unclear_ask_clarify',
    variant: 3,
  ...
  // availability_subject_to_confirmation
  {
    ...
    variant: 1,
    text: `Hi those dates look available based on what I'm seeing, though it's subject to final confirmation.\n\nI'll double-check and come back to you shortly.\n\nMany thanks`,
  },
